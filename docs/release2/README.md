...
* **UI: Log in** - Integrated UI with user repo
* **UI: Feed** - Implemented the feed UI and integrated it with the post repository
* **UI: Make New Post** - Integrated UI with post repo and improved UI
